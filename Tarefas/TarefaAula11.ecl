...
EXPORT TarefaAula11 (STRING Block_info):= FUNCTION
	...
	RETURN OUTPUT(mytable, NAMED('FilteredTable'));
END;


viz_Column := Visualizer.MultiD.Column('myChart',/*datasource*/, 'FilteredTable');
viz_Column;